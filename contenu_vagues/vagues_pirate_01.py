"""
A quoi sert le fichier : Ce fichier contient la configuration des vagues pour le monde pirate niveau 1. Il charge automatiquement les vagues 1 à 4 depuis le générateur de vagues, ce qui permet de définir les ennemis, leur nombre, leur timing et leurs caractéristiques pour chaque vague de ce niveau spécifique.
